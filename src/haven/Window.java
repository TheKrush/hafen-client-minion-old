...
public class Window extends Widget implements DTarget {
    ...
    public static final Text.Foundry tf = new Text.Foundry(Text.serif.deriveFont(Font.BOLD, 15)).aa(true);
    public static final Text.Furnace cf = new Text.Imager(new PUtils.TexFurn(tf, ctex)) {
